...
import sty from "./PlasmicFeatureItem.module.css"; // plasmic-import: molQgoumCOqo/css
...
function PlasmicFeatureItem__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox___3Zznu)}>
        <div className={classNames(projectcss.all, sty.freeBox__i8Dio)} />

        <div className={classNames(projectcss.all, sty.freeBox___6Askq)}>
          <Stack__
            as={"div"}
            hasGap={true}
            className={classNames(projectcss.all, sty.freeBox__gQjOg)}
          >
            <div
              className={classNames(
                projectcss.all,
            ...
            <div className={classNames(projectcss.all, sty.freeBox__caGdr)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
