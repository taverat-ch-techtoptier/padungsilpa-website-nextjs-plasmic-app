...
import sty from "./PlasmicMenuButton.module.css"; // plasmic-import: vOCTxqL3X3fh/css
...
function PlasmicMenuButton__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      >
        <BarsIcon
          className={classNames(projectcss.all, sty.svg__frLlv, {
            [sty.svgexpanded__frLlvMzWo]: hasVariant(
              $state,
              "expanded",
              "expanded"
            )
        ...
        <TimesIcon
          className={classNames(projectcss.all, sty.svg__nwAeb, {
            [sty.svgexpanded__nwAebMzWo]: hasVariant(
              $state,
              "expanded",
              "expanded"
            )
